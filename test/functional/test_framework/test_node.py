...
class TestNode():
    ...
    def __init__(self, i, datadir, *, chain, rpchost, timewait, timeout_factor, bitcoind, bitcoin_cli, coverage_dir, cwd, extra_conf=None, extra_args=None, use_cli=False, start_perf=False, use_valgrind=False, version=None, descriptors=False):
        ...
        self.bitcoinconf = os.path.join(self.datadir, "junkcoin.conf")
    ...
    PRIV_KEYS = [
            # address , privkey (Junkcoin regtest P2PKH prefix 47, WIF prefix 153)
            AddressKeyPair('Kyq9V69JFRuYQKQ49abUXrR7QJ46S3y8aM', 'Pmx1y94spbasKpbVK9kt5AxtNbeMJEN7WitLEpZbgCHrUqYoeoY9'),
            AddressKeyPair('L7tViTTVXAidcJUYTY1FJNSMaZ538CfUmg', 'Pm6eM6LcVvZLbxS78xThqo3i3Z1G9TTPv5a7ZtcLtekCFaGucVq1'),
            AddressKeyPair('L3BBBQtqhv76XhoVnDppqZrmzoZ6Zp9r5m', 'PjzTwkks7RWoJ5uHs1Co6Lzm2Q6jhD2m3LsGdAFVD6QmnGMfb8sN'),
            AddressKeyPair('L5gJodngnLNqK8xrf5AdLFd5BrRC9SEkNM', 'Pn369h8KYRuQcRMmYVAu5eTLjrZg37ziBLGJZT4PxRCz6rizaDrp'),
            AddressKeyPair('L7uybAMVBYKsRMthCuRavgAqw3M9UXKrzc', 'PgLy22LFgMzziig9H4fZymQnZH8dLGmgAtho6owuPPAd7u32fBNx'),
            AddressKeyPair('LHEBtXiVu8smKQqCTuRXTji4nu4waYpYU5', 'PgiXbnQ5HE3VVUDBiRE2rKYd5MXZWDGAVH8W3zX4MZyNRjKzVAM8'),
            AddressKeyPair('LENJP1MWS7PraY4hM95GH7xJk9Ba3C7tUw', 'PgVb3TKa6uRMqeEYr5gzycsJJPyrhkBh5grmjGm4fg62w6b82dpu'),
            AddressKeyPair('LA9LSdHTAQaK992DmKry1tvoWywWmyNbYW', 'PifYFSY8Zb25tsESG6RWnhpz4WBhk6WQB9eHkBxj1rRAhKScSypH'),
            AddressKeyPair('L4rWZKNFvCe8DwfxYPnKXfSad6oN5cxvjj', 'PiwJiDuPzc49FYLJ25bJBWKt1gNLgYwNB39AH9UYMtgGZxoSi7nt'),
            AddressKeyPair('L5S4ARZBJjErCHrBAmqBj5o5bJvoXqPZZs', 'PeCrThfeEb77NfY6kzYskefwRQCGRu5vfbYKDr6K7VMUH8yVwVSG'),
            AddressKeyPair('L4cZGGf5fnCaLc8JvxaEVxzRUKTX8qRwvZ', 'PjFc9EgetXkQZRBkP75mPYsLgHpCc88q24XGYmo4VpRuY6gLkKH1'),
            AddressKeyPair('LEo37TUvDj3znb3xe2KdcwXsyaUfLo8hsS', 'PfrCLM8xJWfc9msHxESrPjXustVyvJ4zVKWNGmwMuE9ZRUZktMPZ'),
    ]
