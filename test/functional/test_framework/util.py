...
def initialize_datadir(dirname, n, chain):
    ...
    with open(os.path.join(datadir, "junkcoin.conf"), 'w', encoding='utf8') as f:
...
def append_config(datadir, options):
    with open(os.path.join(datadir, "junkcoin.conf"), 'a', encoding='utf8') as f:
...
def get_auth_cookie(datadir, chain):
    user = None
    password = None
    if os.path.isfile(os.path.join(datadir, "junkcoin.conf")):
        with open(os.path.join(datadir, "junkcoin.conf"), 'r', encoding='utf8') as f:
            for line in f:
