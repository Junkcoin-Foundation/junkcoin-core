...
Modular library for supporting Junkcoin's implementation of the MWEB (Mimblewimble Extension Block). 
...
### crypto/
Crypto libraries not provided by junkcoin or secp256k1-zkp.
...
While boost\:\:filesystem is already pulled in by junkcoin, I was uncomfortable with its API and its handling of unicode conversions.
...
and just replace the more-limited secp256k1 dependency that's already included in Junkcoin.
