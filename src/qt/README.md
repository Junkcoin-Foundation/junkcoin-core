This directory contains the JunkcoinQT graphical user interface (GUI). It uses the cross-platform framework [Qt](https://www1.qt.io/developers/).
...
Represents the main window of the Junkcoin UI.
...
Used to process BIP21 payment URI requests. Also handles URI based application switching (e.g. when following a junkcoin:... link from a browser).
...
10. Start debugging with Qt Creator (you might need to the executable to "junkcoin-qt" under "Run", which is where you can also add command line arguments)
