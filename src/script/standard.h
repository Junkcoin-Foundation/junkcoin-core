...
//! CTxDestination subtype encoding a BIP341 taproot output (witness v1, 32-byte program)
 ...
 */
typedef boost::variant<CNoDestination, PKHash, ScriptHash, WitnessV0ScriptHash, WitnessV0KeyHash, WitnessV1Taproot, WitnessUnknown, StealthAddress> CTxDestination;
...
private:
     ...
     */
    std::vector<boost::optional<NodeInfo>> m_branch;
