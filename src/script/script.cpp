...
{
    // Junkcoin: BIP342 designated the historically-disabled opcodes as
    // OP_SUCCESSx. Once those opcodes are re-enabled they must execute with
    // their real semantics inside tapscript instead of unconditionally
    // succeeding, otherwise any tapleaf using them would be anyone-can-spend.
