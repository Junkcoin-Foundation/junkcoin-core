...
enum
{
    ...
    bitcoinconsensus_SCRIPT_FLAGS_VERIFY_DISABLED_OPCODES_REENABLED = (1U << 21), // Junkcoin: re-enable legacy disabled opcodes (OP_CAT, OP_MUL, ...)
    bitcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL                 = bitcoinconsensus_SCRIPT_FLAGS_VERIFY_P2SH | bitcoinconsensus_SCRIPT_FLAGS_VERIFY_DERSIG |
                                                               ...
                                                               bitcoinconsensus_SCRIPT_FLAGS_VERIFY_DISABLED_OPCODES_REENABLED
};
...
EXPORT_SYMBOL int bitcoinconsensus_verify_script_with_spent_outputs(const unsigned char *scriptPubKey, unsigned int scriptPubKeyLen,
                                    const unsigned char *txTo, unsigned int txToLen,
