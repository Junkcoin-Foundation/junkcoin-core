...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " junkcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  junkcoin-tx [options] <hex-tx> [commands]  Update hex-encoded junkcoin transaction\n" +
            "or:     junkcoin-tx [options] -create [commands]   Create hex-encoded junkcoin transaction\n" +
            "\n";
